...
export const Nav = ({ authData, setAuthData }) => {
  ...
  return (
    <div className="navbar bg-transparent border-b-2 z-50 border-neutral shadow-sm px-4 md:px-24 lg:px-56 sticky backdrop-blur-lg top-0">
        ...
        {authData ? (
          <div className="avatar placeholder cursor-pointer">
            <div className="bg-primary text-primary-content rounded-full w-10">
              <span className="text-xl font-bold">{authData.charAt(0).toUpperCase()}</span>
            </div>
          </div>
        ) : (
